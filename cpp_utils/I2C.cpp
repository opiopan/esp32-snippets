 ...
 * @return N/A.
 */
void I2C::init(uint8_t address, gpio_num_t sdaPin, gpio_num_t sclPin, uint32_t clockSpeed, i2c_port_t portNum, bool builtinPullup) {
	...
	conf.sda_pullup_en    =
	    builtinPullup ? GPIO_PULLUP_ENABLE : GPIO_PULLUP_DISABLE;
	conf.scl_pullup_en    =
	    builtinPullup ? GPIO_PULLUP_ENABLE : GPIO_PULLUP_DISABLE;
